...
{
    /// <summary>
    /// R2 - Value converter that translates values greater than IntValue to <see cref="Visibility.Collapsed"/> 
    /// and false to
    /// <see cref="Visibility.Visible"/>.
    /// </summary>
    public sealed class GreaterThanIntToVisibilityConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            return (value is int && (int)value > IntValue) ^ IsInversed ? Visibility.Visible : Visibility.Collapsed;
        }
